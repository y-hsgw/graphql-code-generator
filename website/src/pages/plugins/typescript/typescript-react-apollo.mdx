...
description:
  GraphQL Code Generator plugin for TypeScript and React Apollo. Generates React Hooks and HOCs for
...
ready-to-use React Hook for each operation you have.

In your application code, you can import it from the generated file, and use the React Hook in your
component code:
...
Codegen also supports generating data Components (deprecated in `@apollo/client` v3), you can turn
it on this way:
...
Codegen also supports generating High-Order-Components (deprecated in `@apollo/client` v3), you can
turn it on this way:
...
<Callout>
  Watch [Episode #29 of
  `graphql.wtf`](https://graphql.wtf/episodes/29-apollo-client-3-with-graphql-code-generator) for a
  quick introduction to using this plugin with GraphQL Code Generator:
</Callout>
