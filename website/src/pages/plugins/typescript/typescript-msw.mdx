...
[MSW](https://mswjs.io/) is a powerful tool for mocking HTTP requests in your tests and development
environment. This plugin generates typed mock function wrappers for your GraphQL operations.
...
If you are using the [`client`](https://the-guild.dev/graphql/codegen/plugins/presets/preset-client)
...
[`msw` docs site](https://mswjs.io/docs/api/graphql#resolver-argument).
