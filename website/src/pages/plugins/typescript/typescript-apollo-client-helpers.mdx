...
description:
  Generates helpers for improving the integration of TypeScript and Apollo-Client, based on your
  schema. This plugin generates fully-typed keyFields and Type-Policies for Apollo-Client.
---
...
This plugin generates helpers for improving the integration of TypeScript and Apollo-Client, based
on your schema.
